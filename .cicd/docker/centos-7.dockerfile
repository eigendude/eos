...
ENV PRE_COMMANDS="systemctl start buildkite-agent && touch test && buildkite-agent artifact upload test && source /opt/rh/devtoolset-8/enable && source /opt/rh/rh-python36/enable && export PATH=/usr/lib64/ccache:\$PATH"
